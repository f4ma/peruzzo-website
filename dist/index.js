...
(() => {
          ...
          Expr = jQuery.expr = {
            ...
            pseudos: {
              ...
              not: markFunction(function(selector3) {
                ...
                return matcher[expando2] ? markFunction(function(seed, matches3, _context3, xml) {
  ...
  function unSplitWords(element) {
    if (!get(element).isWord) {
      toArray3(element.children).forEach(function(child2) {
  ...
  function Media(Splide2, Components2, options) {
    ...
    function setup() {
      ...
      ownKeys2(breakpoints).sort(function(n2, m) {
  ...
  // node_modules/.pnpm/gsap@3.12.2/node_modules/gsap/Draggable.js
  init_live_reload();
  ...
  var _parseRect = function _parseRect2(e) {
    ...
    var doc = e.ownerDocument || _doc4, r2 = !_isUndefined3(e.pageX) ? {
  ...
  var _parseInertia = function _parseInertia2(draggable, snap3, max2, min2, factor, forceZeroVelocity) {
    var vars = {}, a, i2, l2;
    if (snap3) {
  ...
  var ScrollProxy = function ScrollProxy2(element, vars) {
    ...
    this.left = function(value, force) {
      ...
      if (offsetLeft || oldOffset) {
        if (!this._skip) {
          style2[_transformProp3] = transformStart + -offsetLeft + "px," + -offsetTop + transformEnd;
        }
  ...
  var _initCore3 = function _initCore4(required) {
    if (_windowExists5() && document.body) {
      ...
      _addPaddingBR = function() {
        var div = _createElement3("div"), child2 = _createElement3("div"), childStyle = child2.style, parent = _body2, val;
    ...
    function Draggable2(target, vars) {
      ...
      var type = (vars.type || "x,y").toLowerCase(), xyMode = ~type.indexOf("x") || ~type.indexOf("y"), rotationMode = type.indexOf("rotation") !== -1, xProp = rotationMode ? "rotation" : xyMode ? "x" : "left", yProp = xyMode ? "y" : "top", allowX = !!(~type.indexOf("x") || ~type.indexOf("left") || type === "scroll"), allowY = !!(~type.indexOf("y") || ~type.indexOf("top") || type === "scroll"), minimumMovement = vars.minimumMovement || 2, self2 = _assertThisInitialized2(_this2), triggers = _toArray(vars.trigger || vars.handle || target), killProps = {}, dragEndTime = 0, checkAutoScrollBounds = false, autoScrollMarginTop = vars.autoScrollMarginTop || 40, autoScrollMarginRight = vars.autoScrollMarginRight || 40, autoScrollMarginBottom = vars.autoScrollMarginBottom || 40, autoScrollMarginLeft = vars.autoScrollMarginLeft || 40, isClickable = vars.clickableTest || _isClickable, clickTime = 0, gsCache = target._gsap || gsap2.core.getCache(target), isFixed = _isFixed3(target), getPropAsNum = function getPropAsNum2(property, unit2) {
        ...
        if (self2.autoScroll && self2.isDragging && (checkAutoScrollBounds || dirty)) {
          var e = target, autoScrollFactor = self2.autoScroll * 15, parent, isRoot, rect2, pointerX, pointerY, changeX, changeY, gap;
          ...
          while (e && !isRoot) {
            ...
            if (allowY) {
              ...
              if (gap < 0) {
                changeY = gap;
              } else if (pointerY > rect2.bottom - autoScrollMarginBottom && gap) {
                checkAutoScrollBounds = true;
                changeY = Math.min(gap, autoScrollFactor * (1 - Math.max(0, rect2.bottom - pointerY) / autoScrollMarginBottom) | 0);
              } else if (pointerY < rect2.top + autoScrollMarginTop && parent.scrollTop) {
                checkAutoScrollBounds = true;
                changeY = -Math.min(parent.scrollTop, autoScrollFactor * (1 - Math.max(0, pointerY - rect2.top) / autoScrollMarginTop) | 0);
              }
              if (changeY) {
            ...
            if (allowX) {
              ...
              if (gap < 0) {
                changeX = gap;
              } else if (pointerX > rect2.right - autoScrollMarginRight && gap) {
                checkAutoScrollBounds = true;
                changeX = Math.min(gap, autoScrollFactor * (1 - Math.max(0, rect2.right - pointerX) / autoScrollMarginRight) | 0);
              } else if (pointerX < rect2.left + autoScrollMarginLeft && parent.scrollLeft) {
                checkAutoScrollBounds = true;
                changeX = -Math.min(parent.scrollLeft, autoScrollFactor * (1 - Math.max(0, pointerX - rect2.left) / autoScrollMarginLeft) | 0);
              }
              if (changeX) {
        ...
        if (_isFunction3(snap3)) {
          return function(n2) {
            ...
            return snap3.call(self2, (n2 > max2 ? max2 + (n2 - max2) * edgeTolerance : n2 < min2 ? min2 + (n2 - min2) * edgeTolerance : n2) * factor) * factor;
          };
        }
        if (_isArray2(snap3)) {
          return function(n2) {
        ...
        if (_isArray2(snap3)) {
          return function(p) {
            var i2 = snap3.length, closest2 = 0, minDist = _bigNum3, x, y, point, dist;
            while (--i2 > -1) {
              point = snap3[i2];
              x = point.x - p.x;
              y = point.y - p.y;
        ...
        var originalEvent = e, wasDragging = self2.isDragging, isContextMenuRelease = self2.vars.allowContextMenu && e && (e.ctrlKey || e.which > 2), placeholderDelayedCall = gsap2.delayedCall(1e-3, removePlaceholder), touches, i2, syntheticEvent, eventTarget, syntheticClick;
        if (touchEventTarget) {
  ...
  var _lockBodyScroll = function _lockBodyScroll2(lock) {
    if (lock !== _bodyLocked) {
      var s2 = _body3.style, w = _body3.clientWidth === window.outerWidth, h = _body3.clientHeight === window.outerHeight, i2 = 4;
      if (lock && (w || h)) {
        while (i2--) {
          _bodyMetrics[i2] = s2[_bodyProps[i2]];
        }
        if (w) {
          s2.width = _body3.clientWidth + "px";
          s2.overflowY = "hidden";
        }
        if (h) {
          s2.height = _body3.clientHeight + "px";
          s2.overflowX = "hidden";
        }
        _bodyLocked = lock;
      } else if (_bodyLocked) {
  ...
  var Flip = /* @__PURE__ */ function() {
    ...
    Flip2.fit = function fit(fromEl, toEl, vars) {
      var v = vars ? _copy3(vars, _fitReserved) : {}, _ref = vars || v, absolute = _ref.absolute, scale = _ref.scale, getVars = _ref.getVars, props = _ref.props, runBackwards = _ref.runBackwards, onComplete = _ref.onComplete, simple = _ref.simple, fitChild = vars && vars.fitChild && _getEl(vars.fitChild), before2 = _parseElementState(toEl, props, simple, fromEl), after = _parseElementState(fromEl, 0, simple, before2), inlineProps = props ? _memoizedRemoveProps[props] : _removeProps;
  ...
  var _default = /* @__PURE__ */ function() {
    function _default2() {
      ...
      Object.assign(this, defaults3, options);
      this.smartphone = defaults3.smartphone;
      if (options.smartphone)
        Object.assign(this.smartphone, options.smartphone);
      this.tablet = defaults3.tablet;
      if (options.tablet)
    ...
    _createClass3(_default2, [{
      ...
      value: function detectElements(hasCallEventSet) {
        ...
        Object.entries(this.els).forEach(function(_ref) {
          var _ref2 = _slicedToArray2(_ref, 2), i2 = _ref2[0], el = _ref2[1];
    ...
    _createClass3(_default2, [{
      ...
      value: function updateElements() {
        ...
        Object.entries(this.els).forEach(function(_ref3) {
          var _ref4 = _slicedToArray2(_ref3, 2), i2 = _ref4[0], el = _ref4[1];
      ...
      value: function transformElements(isForced) {
        ...
        Object.entries(this.parallaxElements).forEach(function(_ref5) {
          var _ref6 = _slicedToArray2(_ref5, 2), i2 = _ref6[0], current = _ref6[1];
